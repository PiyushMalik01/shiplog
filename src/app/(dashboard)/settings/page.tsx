...
export default function SettingsPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-full p-6 md:p-8 max-w-2xl mx-auto">
        <div className="h-7 w-40 rounded-lg bg-[#f1f5f9] animate-pulse mb-2" />
        <div className="h-4 w-64 rounded bg-[#f1f5f9] animate-pulse mb-8" />
        {[1, 2, 3].map(i => (
          <div key={i} className="bg-white rounded-2xl border border-[#e2e8f0] p-6 mb-4">
            <div className="h-4 w-24 rounded bg-[#f1f5f9] animate-pulse mb-5" />
  ...
  return (
    <div className="min-h-full p-6 md:p-8 max-w-2xl mx-auto">
      ...
      <p className="text-[13px] text-[#64748b] mt-1 mb-8">Manage your account and preferences.</p>

      {/* ── Profile Section ── */}
      <section className="bg-white rounded-2xl border border-[#e2e8f0] shadow-sm p-6 mb-4">
        <h2
          className="text-[15px] font-bold text-[#03045e] mb-5 flex items-center gap-2"
          style={{ fontFamily: 'var(--font-syne), Syne, sans-serif' }}
        >
      ...
      <section className="bg-white rounded-2xl border border-[#e2e8f0] shadow-sm p-6 mb-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-[#e2e8f0] text-[14px] text-[#03045e] placeholder:text-[#94a3b8] focus:outline-none focus:ring-2 focus:ring-[#0077b6]/20 focus:border-[#0077b6] transition-colors"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-[#e2e8f0] text-[14px] text-[#03045e] placeholder:text-[#94a3b8] focus:outline-none focus:ring-2 focus:ring-[#0077b6]/20 focus:border-[#0077b6] transition-colors"
        ...
        <div className="flex items-center justify-between mt-5 flex-wrap gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-[12px] font-semibold text-[#64748b] border border-[#e2e8f0] hover:bg-[#f1f5f9] transition-colors cursor-pointer"
          >
