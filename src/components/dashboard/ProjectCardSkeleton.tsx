export default function ProjectCardSkeleton() {
  return (
    <div className="bg-white dark:bg-[#0d1b2e] rounded-2xl border border-[#e2e8f0] dark:border-white/8 overflow-hidden">
      <div className="p-5">
        ...
        <div className="pt-3 border-t border-[#f1f5f9] dark:border-white/6 flex gap-2">
